...
export const ShoppingListItemCard: React.FC<ShoppingListItemCardProps> = ({ item, onEdit, onDelete, onToggleBought, onToggleFocus }) => (
  <div style={{ display: 'flex', alignItems: 'center', background: 'var(--color-bg, #FFF6E5)', borderRadius: 8, boxShadow: 'var(--shadow-card, 0 2px 8px rgba(42,46,53,0.08))', padding: 12, gap: 12 }}>
